...
console.log(`k=${k}, p=${p}, next=${next}`); // k=1, p=2, next=3

[k, p, ...next] = [1, 2, 3, 4, 5, 6, 7, 8];
console.log(`k=${k}, p=${p}, next=${next}`); // k=1, p=2, next=3,4,5,6,7,8

[k, _, p, _, ...next] = [1, 2, 3, 4, 5, 6, 7, 8];
console.log(`k=${k}, p=${p}, next=${next}`); // k=1, p=3, next=5,6,7,8
...
console.log(listHabit); // { id: 2, content: '걷기', completed: true } { id: 3, content: '명상', completed: true }
